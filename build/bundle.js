...
var paddleGap = exports.paddleGap = 10;
var ballRadius = exports.ballRadius = 8;
var boardColor = exports.boardColor = '#353535';
var lineColor = exports.lineColor = '#FFFFFF';
var paddleColor = exports.paddleColor = '#FFFFFF';
var ballColor = exports.ballColor = '#FFFFFF';
...
var Game = function () {
	function Game(element, width, height) {
		...
		this.height = height;
		this.paused = false;
		this.gameBoard = new _Board2.default(width, height);
		this.player1 = new _Paddle2.default(height, _settings.paddleWidth, _settings.paddleHeight, _settings.paddleGap, (height - _settings.paddleHeight) / 2, _settings.KEYS.p1Up, _settings.KEYS.p1Down);
		this.player2 = new _Paddle2.default(height, _settings.paddleWidth, _settings.paddleHeight, width - (_settings.paddleWidth + _settings.paddleGap), (height - _settings.paddleHeight) / 2, _settings.KEYS.p2Up, _settings.KEYS.p2Down);
		this.ball = new _Ball2.default(_settings.ballRadius, width, height);
...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function render(svg) {
      ...
      rect.setAttributeNS(null, 'fill', _settings.boardColor);
      ...
      line.setAttributeNS(null, 'stroke', _settings.lineColor);
